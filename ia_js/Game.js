class Game {
    ...
    getLowestEmptyLine(column) { // ! ?number
    ...
    getDiagonalByHighestCellDescendingRight(lineIndex, columnIndex) { // ! undefined necessaire ?
    ...
    getDiagonalByHighestCellDescendingLeft(lineIndex, columnIndex) { // ! undefined necessaire ?
      const maxCroppedSquareSideLength = Math.min(
        this.height - lineIndex,
        columnIndex + 1
      );
